    ...
    Box(modifier = modifier) {
        ...
        DropdownMenu(
            ...
            FilterOption.entries.forEach { filterOption ->
                DropdownMenuItem(
                    text = { Text(stringResource(filterOption.label)) },
                    leadingIcon = {
                        Icon(
                            painter = painterResource(filterOption.icon),
                            contentDescription = "${stringResource(R.string.filter_title)} ${stringResource(filterOption.label)}"
                        )
                    },
                    trailingIcon = {
                    ...
                    onClick = {
                        onFilterOptionSelected(filterOption)
                        expanded = false
                    }
                )
            }
