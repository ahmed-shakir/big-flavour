...
object LocalProductsDataSource {
    ...
    fun getProducts() =
        mutableListOf(
            ...
            ProductItem("Latte", "Smooth espresso layered beneath steamed milk, poured with artful precision for a gentle, comforting balance.", ProductCategory.DRINK, 8.00, R.drawable.drink_latte, isWeeklySpecial = true),
            ProductItem("Mocha", "A luxurious marriage of dark chocolate and espresso, softened with steamed milk into a decadent indulgence.", ProductCategory.DRINK, 10.00, R.drawable.drink_mocha, isWeeklySpecial = true),
            ...
            ProductItem("Lasagna", "Layers of house-made pasta, slow-cooked ragù, and creamy béchamel, baked to golden, bubbling perfection.", ProductCategory.FOOD, 15.00, R.drawable.dish_lasagna, isWeeklySpecial = true),
            ProductItem("Onion soup", "Caramelized onions in a deep, savory broth, crowned with a crust of melted Gruyère and toasted bread.", ProductCategory.FOOD, 12.00, R.drawable.dish_onion_soup, isWeeklySpecial = true),
            ...
            ProductItem("Custard tart", "A crisp, golden shell cradling a luxuriously smooth vanilla custard, kissed with a hint of nutmeg.", ProductCategory.DESSERT, 14.00, R.drawable.dessert_custard_tart, isWeeklySpecial = true),
